  ...
  return (
    ...
    >
      <div className="absolute top-[0px] left-[0px] bg-white w-full flex flex-col items-start justify-start max-w-full h-full">
        <div className="self-stretch shadow-[0px_1px_0px_#e6e6e6] bg-white flex flex-row items-start justify-center py-3 px-5 gap-[788px] mq450:gap-[98px] mq825:gap-[197px] mq1400:flex-wrap mq1400:gap-[394px]">
          <div className="flex flex-row items-start justify-start gap-[8px]">
            <img
              ...
              alt=""
              src="\src\assets\attracpopular\map-pin.svg"
            />
          ...
          <div className="w-[232px] flex flex-col items-start justify-start pt-px px-0 pb-0 box-border text-center">
            <div className="self-stretch flex flex-row items-start justify-start gap-[19.7px]">
              ...
              <div className="h-4 w-px relative box-border border-r-[1px] border-solid border-gray-300" />
              <nav className="m-0 flex-1 flex flex-row items-start justify-start gap-[4px] text-left text-[12px] text-gray-600 font-body-small-body-small-400">
        ...
        <TagBar1 />
        <div className="self-stretch bg-black flex flex-row items-center justify-between py-4 px-[300px] box-border sticky top-[0] z-[99] gap-[20px] max-w-full text-[14px] text-white mq450:pl-5 mq450:pr-5 mq450:box-border mq825:pl-[75px] mq825:pr-[75px] mq825:box-border mq1400:pl-[150px] mq1400:pr-[150px] mq1400:box-border">
          <div className="w-[590px] flex flex-row items-center justify-start gap-[32px] max-w-full mq825:hidden mq825:gap-[16px]">
            <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-center justify-start gap-[4px]">
              <div className="relative text-[14px] leading-[150%] font-medium font-body-small-body-small-400 text-white text-left inline-block min-w-[42px]">
                Home
              </div>
              <img
                className="h-4 w-4 relative overflow-hidden shrink-0 object-contain"
                alt=""
                src="\src\assets\attracpopular\chevron-down-1.svg"
              />
            </button>
            ...
            <div className="flex flex-row items-center justify-start gap-[4px]">
              ...
              <img
                ...
                alt=""
                src="\src\assets\attracpopular\chevron-down.svg"
              />
            </div>
            <div className="flex flex-row items-center justify-start gap-[4px]">
          ...
          <div className="flex flex-row items-center justify-start gap-[8px] text-white">
            <img
              ...
              loading="lazy"
              alt=""
              src="\src\assets\attracpopular\phonecall-1.svg"
            />
      ...
      <img
        ...
        loading="lazy"
        alt=""
        src="\src\assets\attracpopular\blue-and-orange-simple-ilustration-supermarket-logo--1-removebgpreview-1@2x.png"
      />
    </header>
  );
};
