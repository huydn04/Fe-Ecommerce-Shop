  ...
  return (
    ...
    >
      ...
      <section className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[20px] text-left text-sm text-gray-scale-gray-700 font-heading-05-heading-05-600">
        <ImgSpPopular image="/image@2x.png" greenApple="Táo Xanh" />
        <ImgSpPopular image="/image-1@2x.png" greenApple="Cải Thìa" />
        <ImgSpPopular image="/image-2@2x.png" greenApple="Xà Lách" />
        <div
      ...
      >
        ...
        <ImgSpPopular image="/image-4@2x.png" greenApple="Bắp" />
      </section>
      <section className="self-stretch flex flex-row items-start justify-center gap-[24px] text-left text-xl text-gray-scale-gray-900 font-heading-05-heading-05-600 mq1050:flex-wrap">
        <div className="flex-1 flex flex-col items-start justify-start gap-[16px] min-w-[287px] max-w-[312px]">
          ...
          <SpHotSellerTop image="/image-5@2x.png" chaniseCabbage="Táo Xanh" />
          ...
          <SpHotSellerTop image="/image-7@2x.png" chaniseCabbage="Xà Lách" />
        </div>
        <div className="flex-1 flex flex-col items-start justify-start gap-[16px] min-w-[287px] max-w-[312px]">
          <h3 className="m-0 relative text-inherit leading-[150%] font-medium font-inherit mq450:text-base mq450:leading-[24px]">
            Sản phẩm bán chạy
          </h3>
          <SpHotSellerTop image="/image-8@2x.png" chaniseCabbage="Cà Tím" />
          <SpT image="/image-9@2x.png" chaniseCabbage="Đậu Bắp" />
          <SpHotSellerTop image="/image-10@2x.png" chaniseCabbage="Cà Chua" />
        </div>
        <div className="flex-1 flex flex-col items-start justify-start gap-[16px] min-w-[287px] max-w-[312px]">
          <h3 className="m-0 relative text-inherit leading-[150%] font-medium font-inherit mq450:text-base mq450:leading-[24px]">
            Được đánh giá cao nhất
          </h3>
          <SpHotSellerTop image="/image-11@2x.png" chaniseCabbage="Khoai Tây" />
          <SpT image="/image-12@2x.png" chaniseCabbage="Bắp" />
          <SpHotSellerTop
          ...
          <div className="flex-1 flex flex-col items-start justify-start gap-[16px] z-[1]">
            ...
            <div className="self-stretch h-[45px] flex flex-row items-start justify-start py-0 px-[42px] box-border">
              <Button
                ...
                endIcon={<img width="15px" height="12px" src="/group.svg" />}
                variant="contained"
                sx={{
                  textTransform: "none",
                  color: "#00b307",
