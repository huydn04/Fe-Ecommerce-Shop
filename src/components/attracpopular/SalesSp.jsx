...
const SalesSp = ({ className = "", image, surjapurMango, bag, star5 }) => {
  return (
    <div
    ...
    >
      ...
      <div className="self-stretch flex flex-row items-end justify-start pt-4 px-5 pb-5">
...
SalesSp.propTypes = {
  ...
  surjapurMango: PropTypes.string,
