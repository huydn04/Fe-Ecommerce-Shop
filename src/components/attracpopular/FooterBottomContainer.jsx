...
const FooterBottomContainer = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-left text-sm text-gray-scale-gray-500 font-body-small-body-small-400 ${className}`}
    >
      <div className="w-[1320px] shadow-[0px_-1px_0px_#333] bg-gray-scale-gray-900 flex flex-row items-start justify-between py-6 px-0 box-border max-w-full gap-[20px] lg:flex-wrap lg:justify-center">
        <div className="flex flex-row items-start justify-start py-0 pr-[100px] pl-0 gap-[8px] mq450:pr-5 mq450:box-border">
          <img
            ...
            loading="lazy"
            alt=""
            src="/Fe-Ecommerce-Shop/src/assets/attracpopular/social-media.svg"
          />
          <img
            className="h-10 w-10 relative rounded-481xl min-h-[40px]"
            alt=""
            src="/Fe-Ecommerce-Shop/src/assets/attracpopular/social-media-1.svg"
          />
          <img
            className="h-10 w-10 relative rounded-481xl min-h-[40px]"
            alt=""
        ...
        <div className="w-[277px] flex flex-col items-start justify-start pt-1 px-0 pb-0 box-border text-2xs text-gray-scale-white">
          <div className="self-stretch flex flex-row items-start justify-start gap-[8px]">
            ...
            <div className="w-[65px] rounded-[5.29px] bg-gray-scale-gray-900 box-border flex flex-col items-start justify-start py-0.5 px-0 gap-[1px] border-[1px] border-solid border-gray-scale-gray-800">
              ...
              <div className="self-stretch relative text-xs leading-[100%] font-semibold text-center inline-block min-w-[65px] z-[1]">
                Payment
              </div>
            </div>
          </div>
