        ...
        <div className=" w-[1300px]">
          ...
          <div className="border-solid border-gray-400 border w-full flex flex-row justify-between	">
              ...
              <div className="mt-6">
                <form action="" method="post">
                  <div className="ml-4">
                    ...
                    <br />
                    <input
                      className="mt-1 mb-6 border-solid border rounded w-96 h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="text"
                    />
                  </div>
                  ...
                  <input
                    className=" w-40 h-10 rounded-3xl text-white ml-4 mt-6 mb-6 bg-[#00B207] cursor-pointer"
                    value="Lưu Thay Đổi"
                    type="submit"
                  />
                </form>
            ...
            <div className="mt-14 w-full border-t border-solid border-gray-400 flex flex-col justify-center items-center">
              <img
                className="w-60"
                src="https://cutitoutvinyl.ca/wp-content/uploads/2022/10/Cut-it-Out-Vinyl-7.png"
                alt=""
              />
              <button
                className=" w-40 h-10 rounded-3xl border-2 font-bold border-solid boder-[#00B207] text-[#00B207] ml-4 mt-3 "
                type="submit"
              >
                Chọn Ảnh
              </button>
                ...
                <form action="" method="post">
                  ...
                  <div className="flex flex-row w-full ">
                    <div className="ml-4">
                      ...
                      <br />
                      <input
                        className="mt-1 mr-2 mb-7 border-solid border rounded w-[285px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                        type="text"
                      />
                    </div>
                  ...
                  <div className="ml-4 w-96">
                    ...
                    <br />
                    <input
                      className=" mt-1 mb-7 border-solid border rounded w-[900px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="text"
                    />
                  </div>
                  ...
                  <div className="flex flex-row w-full ">
                    <div className="ml-4">
                      ...
                      <br />
                      <input
                        className="mt-1 mb-7 mr-7 border-solid border rounded w-[430px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                        type="text"
                      />
                    </div>
                    ...
                    <div className="ml-4">
                      ...
                      <br />
                      <input
                        className="mt-1 mb-7 border-solid border rounded w-[430px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                        type="text"
                      />
                    </div>
                  </div>
              ...
              <div className="mt-6">
                <form action="" method="post">
                  <div className="ml-4">
                    ...
                    <br />
                    <input
                      className="mt-1 mb-6 border-solid border rounded w-[900px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="password"
                    />
                  </div>
                  ...
                  <div className="flex flex-row w-full ">
                    <div className="ml-4">
                      ...
                      <br />
                      <input
                        className="mt-1 mb-7 mr-10 border-solid border rounded w-[420px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                        type="password"
                      />
                    </div>
                    ...
                    <div className="ml-4">
                      ...
                      <br />
                      <input
                        className="mt-1 mb-7 border-solid border rounded w-[420px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                        type="password"
                      />
                    </div>
                  </div>
              ...
              <form action="" method="post">
                ...
                <div className="flex flex-row w-full ">
                  <div className="ml-4">
                    ...
                    <br />
                    <input
                      className="mt-1 mr-2 mb-7 border-solid border rounded w-[236px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="text"
                    />
                  </div>
                  ...
                  <div className="ml-4  ">
                    ...
                    <br />
                    <input
                      className="w-full mt-1 mr-2 mb-7 border-solid border rounded w-[236px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="text"
                    />
                  </div>
                </div>
                ...
                <div className="ml-4 w-96">
                  ...
                  <br />
                  <input
                    className=" mt-1 mb-7 border-solid border rounded w-[760px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                    type="text"
                  />
                </div>
                ...
                <div className="flex flex-row w-full ">
                  <div className="ml-4">
                    ...
                    <br />
                    <input
                      className="mt-1 mb-7 mr-7 border-solid border rounded w-[360px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="text"
                    />
                  </div>
                  ...
                  <div className="ml-4">
                    ...
                    <br />
                    <input
                      className="mt-1 mb-7 border-solid border rounded w-[360px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="text"
                    />
                  </div>
                </div>
            ...
            <div className="mt-6">
              <form action="" method="post">
                <div className="ml-4">
                  ...
                  <br />
                  <input
                    className="mt-1 mb-6 border-solid border rounded w-[760px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                    type="password"
                  />
                </div>
                ...
                <div className="flex flex-row w-full ">
                  <div className="ml-4">
                    ...
                    <br />
                    <input
                      className="mt-1 mb-7 mr-10 border-solid border rounded w-[350px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="password"
                    />
                  </div>
                  ...
                  <div className="ml-4">
                    ...
                    <br />
                    <input
                      className="mt-1 mb-7 border-solid border rounded w-[350px] h-9 pl-2 focus:outline-none focus:border-[#00B207]"
                      type="password"
                    />
                  </div>
                </div>
