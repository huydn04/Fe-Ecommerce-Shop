...
const AttractiveOffers = () => {
  ...
  /
        ...
        <div className="w-[1320px] flex flex-col items-start justify-start gap-[100px] max-w-full mq450:gap-[25px] mq825:gap-[50px]">
          <div className="self-stretch flex flex-col items-start justify-start gap-[50px] max-w-full mq825:gap-[25px]">
            <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
              <h1 className="m-0 w-[508px] relative text-inherit leading-[120%] font-semibold font-inherit inline-block shrink-0 max-w-full mq450:text-[24px] mq450:leading-[29px] mq825:text-[32px] mq825:leading-[38px]">
                Gợi Ý Hôm Nay
              </h1>
            </div>
            <div className="self-stretch flex flex-row flex-wrap items-start justify-center [row-gap:20px] text-left text-[14px] text-gray-950">
              <div className="h-[328px] flex-1 bg-white box-border flex flex-col items-start justify-start pt-0 px-0 pb-[87px] gap-[0.5px] min-w-[260px] max-w-[265px] text-white border-[1px] border-solid border-gray-300 mq450:pb-[57px] mq450:box-border">
                ...
                <div className="self-stretch flex flex-col items-start justify-center p-3 relative gap-[6px] shrink-0 text-gray-950">
                  <div className="self-stretch flex flex-col items-start justify-start">
                    <div className="self-stretch relative leading-[150%]">
                      Táo Xanh
                    </div>
                    <div className="flex flex-row items-start justify-start gap-[2px] text-[16px] text-gray-900">
                      <div className="relative leading-[150%] font-medium inline-block min-w-[51px] whitespace-nowrap">
                        $14.99
                      </div>
                      <div className="relative [text-decoration:line-through] leading-[150%] text-gray-400 inline-block min-w-[53px] whitespace-nowrap">
                        $20.99
                      </div>
                    </div>
                  </div>
              ...
              <div className="h-[328px] flex-1 bg-white box-border flex flex-col items-start justify-start pt-0 px-0 pb-[87px] gap-[0.5px] min-w-[260px] max-w-[265px] border-[1px] border-solid border-gray-300 mq450:pb-[57px] mq450:box-border">
                ...
                <div className="self-stretch flex flex-col items-start justify-center p-3 relative gap-[6px] shrink-0">
                  <div className="self-stretch flex flex-col items-start justify-start">
                    ...
                    <div className="flex flex-row items-start justify-start text-[16px] text-gray-900">
          ...
          <div className="self-stretch grid flex-row items-start justify-start gap-[43px] grid-cols-[repeat(3,_minmax(318px,_1fr))] max-w-full text-[14px] text-white [1200px]:grid-cols-[repeat(2,_minmax(318px,_551px))] [1200px]:justify-center mq825:grid-cols-[minmax(318px,_1fr)]">
            <div className="flex flex-col items-start justify-start pt-[35px] px-0 pb-[294px] box-border relative gap-[16px] max-w-full mq825:pt-[23px] mq825:pb-[191px] mq825:box-border">
              <img
                className="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-[18px] max-w-full overflow-hidden max-h-full object-cover"
                alt=""
              ...
              <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-2 gap-[8px] text-[40px]">
                <h1 className="m-0 self-stretch relative text-inherit leading-[120%] font-semibold font-inherit z-[1] mq450:text-[24px] mq450:leading-[29px] mq825:text-[32px] mq825:leading-[38px]">
                  Tháng siêu sale
                </h1>
                <div className="self-stretch flex flex-row items-start justify-start py-0 px-[67px] text-[24px] mq450:pl-5 mq450:pr-5 mq450:box-border">
                  <div className="flex-1 flex flex-row items-start justify-start gap-[8px] z-[1]">
                    <div className="flex-1 rounded-md flex flex-col items-start justify-start gap-[4px]">
                      <div className="self-stretch relative leading-[150%] mq450:text-[19px] mq450:leading-[29px]">
                        00
                      </div>
                      <div className="flex flex-row items-start justify-start py-0 pr-[11px] pl-2.5 text-[12px] text-stone-50">
                        <div className="relative tracking-[0.03em] leading-[100%] uppercase inline-block min-w-[35px]">
                          ngày
                        </div>
                      </div>
                    </div>
                    <h2 className="m-0 relative text-inherit leading-[150%] font-normal font-inherit text-gray-100 inline-block min-w-[6px] mq450:text-[19px] mq450:leading-[29px]">
                      :
                    </h2>
                    <div className="flex-1 rounded-md flex flex-col items-start justify-start gap-[4px]">
                      <div className="self-stretch relative leading-[150%] mq450:text-[19px] mq450:leading-[29px]">
                      ...
                      <div className="flex flex-row items-start justify-start py-0 pr-2.5 pl-[9px] text-[12px] text-stone-50">
                    ...
                    <div className="flex-1 rounded-md flex flex-col items-start justify-start gap-[4px]">
                      ...
                      <div className="flex flex-row items-start justify-start py-0 pr-3 pl-[11px] text-[12px] text-stone-50">
                    ...
                    <div className="flex-1 rounded-md flex flex-col items-start justify-start gap-[4px]">
                      ...
                      <div className="flex flex-row items-start justify-start py-0 px-[13px] text-[12px] text-stone-50">
            ...
            <div className="flex flex-col items-start justify-start pt-[35px] px-0 pb-[307px] box-border relative gap-[28.5px] max-w-full mq825:pt-[23px] mq825:pb-[200px] mq825:box-border">
              <img
                className="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-[20px] max-w-full overflow-hidden max-h-full object-cover"
                alt=""
              ...
              <div className="self-stretch flex flex-col items-end justify-start gap-[12.5px]">
                <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
                  ...
                  <h1 className="m-0 self-stretch relative text-[40px] leading-[120%] font-semibold font-inherit z-[1] mq450:text-[24px] mq450:leading-[29px] mq825:text-[32px] mq825:leading-[38px]">
                    Thịt Ít Mỡ
                  </h1>
                </div>
                <div className="self-stretch flex flex-row items-start justify-center py-0 pr-5 pl-[21px] text-[18px]">
                  <div className="w-[145px] flex flex-row items-start justify-start gap-[8px] z-[1]">
                    ...
                    <div className="relative text-[20px] leading-[150%] font-semibold text-orange-500 inline-block min-w-[67px] whitespace-nowrap mq450:text-[16px] mq450:leading-[43px]">
                      $79.99
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-col items-start justify-start pt-[28.5px] px-0 pb-[307px] box-border relative gap-[28.5px] max-w-full text-[12px] text-gray-900 pt-[25px] mq825:pb-[200px] mq825:box-border">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[18px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[10px] text-[38px]">
                  <h1 className="m-0 self-stretch relative text-inherit leading-[46px] font-semibold font-inherit z-[1] mq450:text-[23px] mq450:leading-[27px] mq825:text-[30px] mq825:leading-[36px]">
                    100% Trái Cây Tươi
                  </h1>
                  <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 text-[18px]">
                    <div className="flex flex-row items-start justify-start gap-[12px] z-[1]">
                      ...
                      <div className="rounded-[5px] bg-gray-900 flex flex-row items-start justify-start py-1.5 px-3 whitespace-nowrap text-yellow-300">
      ...
      <section className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[76px] box-border max-w-full text-left text-[40px] text-gray-900 font-body-small-body-small-400 mq825:pb-[49px] mq825:box-border">
        <div className="flex-1 bg-gray-100 flex flex-col items-start justify-start py-[100px] px-0 box-border gap-[50px] max-w-full mq825:gap-[25px] mq825:pt-[65px] mq825:pb-[65px] mq825:box-border">
          <div className="self-stretch flex flex-row items-start justify-between py-0 px-[300px] box-border max-w-full gap-[20px] [1200px]:pl-[150px] [1200px]:pr-[150px] [1200px]:box-border mq825:pl-[75px] mq825:pr-[75px] mq825:box-border mq1400:flex-wrap">
            <div className="flex flex-col items-start justify-start gap-[16px] max-w-full">
              <h1 className="m-0 relative text-inherit leading-[120%] font-semibold font-inherit mq450:text-[24px] mq450:leading-[29px] mq825:text-[32px] mq825:leading-[38px]">
                Đánh giá của khách hàng
              </h1>
              <div className="w-[72px] flex flex-row items-start justify-between relative gap-[20px]">
                <div className="h-1 w-3 relative bg-lime-300" />
                <div className="h-full w-10 absolute !m-[0] top-[0px] bottom-[0px] left-[calc(50%_-_20px)] bg-green-600" />
                <div className="h-1 w-3 relative bg-lime-300" />
              </div>
            </div>
      ...
      <footer className="self-stretch bg-gray-900 flex flex-col items-start justify-start gap-[80px] max-w-full text-left text-[24px] text-gray-900 font-body-small-body-small-400 [1200px]:gap-[40px] mq825:gap-[20px]">
        <div className="self-stretch bg-gray-50 flex flex-row items-start justify-center py-[50.5px] pr-5 pl-[357px] box-border relative max-w-full [row-gap:20px] mq450:pl-5 mq450:box-border mq825:pl-[89px] mq825:box-border mq1400:flex-wrap mq1400:pl-[178px] mq1400:box-border">
          <div className="h-[162px] w-[1920px] relative bg-gray-50 hidden max-w-full z-[0]" />
